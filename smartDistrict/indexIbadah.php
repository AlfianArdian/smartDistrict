...
<html lang="en">
    ...
    <body>
        ...
        <?php include 'koneksi.php'; ?>
          ...
          <?php
              $queryLowok = mysqli_query($conn, "SELECT * FROM tempat_ibadah WHERE id_kecamatan = 1");
              $dataLowok = mysqli_fetch_assoc($queryLowok);
              //
              $queryKedung = mysqli_query($conn, "SELECT * FROM tempat_ibadah WHERE id_kecamatan = 2");
              $dataKedung = mysqli_fetch_assoc($queryKedung);
              //
              $queryKloj = mysqli_query($conn, "SELECT * FROM tempat_ibadah WHERE id_kecamatan = 3");
              $dataKloj = mysqli_fetch_assoc($queryKloj);
              //
              $queryBlim = mysqli_query($conn, "SELECT * FROM tempat_ibadah WHERE id_kecamatan = 4");
              $dataBlim = mysqli_fetch_assoc($queryBlim);
              //
              $querySuk = mysqli_query($conn, "SELECT * FROM tempat_ibadah WHERE id_kecamatan = 5");
            ...
            var geojsone = {
              ...
              features: [
                // blimbing
                {
                  ...
                  properties: {
                    title: 'Blimbing District<br><br>Masjid: <?= $dataBlim['Masjid'];?><br>Gereja: <?= $dataBlim['Gereja'];?><br>Klenteng: <?= $dataBlim['Klenteng'];?><br>Vihara: <?= $dataBlim['Vihara'];?><br>Pura: <?= $dataBlim['Pura'];?>',
              ...
              // klojen
                {
                  ...
                  properties: {
                    title: 'Klojen District<br><br>Masjid: <?= $dataKloj['Masjid'];?><br>Gereja: <?= $dataKloj['Gereja'];?><br>Klenteng: <?= $dataKloj['Klenteng'];?><br>Vihara: <?= $dataKloj['Vihara'];?><br>Pura: <?= $dataKloj['Pura'];?>',
              ...
              // lowokwaru
                {
                  ...
                  properties: {
                    title: 'Lowokwaru District<br><br>Masjid: <?= $dataLowok['Masjid'];?><br>Gereja: <?= $dataLowok['Gereja'];?><br>Klenteng: <?= $dataLowok['Klenteng'];?><br>Vihara: <?= $dataLowok['Vihara'];?><br>Pura: <?= $dataLowok['Pura'];?>',
                ...
                // kedungkandang
                {
                  ...
                  properties: {
                    title: 'Kedungkandang District<br><br>Masjid: <?= $dataKedung['Masjid'];?><br>Gereja: <?= $dataKedung['Gereja'];?><br>Klenteng: <?= $dataKedung['Klenteng'];?><br>Vihara: <?= $dataKedung['Vihara'];?><br>Pura: <?= $dataKedung['Pura'];?>',
                    description: '<a href=\"lowokwaru.php\" target=\"_blank\" title=\"Opens in a new window\">Subdistrict</a>'
                  }
                },
                // sukun
                {
                  ...
                  properties: {
                    title: 'Sukun District<br><br>Masjid: <?= $dataSuk['Masjid'];?><br>Gereja: <?= $dataSuk['Gereja'];?><br>Klenteng: <?= $dataSuk['Klenteng'];?><br>Vihara: <?= $dataSuk['Vihara'];?><br>Pura: <?= $dataSuk['Pura'];?>',
